...
var bio = "Joseph James is a self taught programmer and aspiring software engineer Joseph works with code bases and their corresponding tools methodically in order to achieve consistent results.  Joseph believes that with good process and communication, any code base can be systematically broken down into its simplest components, understood with precision, and then optimized for efficieny and expanded capability.  In his spare time Joseph is an avid reader of science ficition and fantasy novels, hobbyist mycologist, botanist, and gamer. Joseph James holds a Bachelor of Arts in Philosophy from Florida Internation University.  As a technologically inclined philosopher, Joseph is keenly aware of the vast area of unexplored possibilities modern technology has unlocked and looks forward to the future."
